...
[worten.pt](https://worten.pt/) scraper powered by [Scrapeless](https://www.scrapeless.com/). Every surface drives a Scrapeless cloud [Scraping Browser](https://www.scrapeless.com/en/scraping-browser) and emits identical JSON shapes — see [`DATA_MODEL.md`](DATA_MODEL.md).
...
- [`browser/nodejs/results/category.json`](browser/nodejs/results/category.json)
