...
[news.google.com](https://news.google.com/) scraper powered by [Scrapeless](https://www.scrapeless.com/). Every surface drives a Scrapeless cloud [Scraping Browser](https://www.scrapeless.com/en/scraping-browser) and emits identical JSON shapes — see [`DATA_MODEL.md`](DATA_MODEL.md).
...
| Python | Node.js |
| --- | --- |
| `scrape_news` | `scrapeNews` |
| `scrape_topic` | `scrapeTopic` |
