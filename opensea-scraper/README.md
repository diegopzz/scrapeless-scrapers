...
[opensea.io](https://opensea.io/) scraper powered by [Scrapeless](https://www.scrapeless.com/). Every surface drives a Scrapeless cloud [Scraping Browser](https://www.scrapeless.com/en/scraping-browser) and emits identical JSON shapes — see [`DATA_MODEL.md`](DATA_MODEL.md).
...
| Python | Node.js |
| --- | --- |
| `scrape_collection` | `scrapeCollection` |
| `scrape_asset` | `scrapeAsset` |
...
- [`browser/nodejs/results/asset.json`](browser/nodejs/results/asset.json)
- [`browser/nodejs/results/collection.json`](browser/nodejs/results/collection.json)
