...
[instagram.com](https://instagram.com/) scraper powered by [Scrapeless](https://www.scrapeless.com/). Every surface drives a Scrapeless cloud [Scraping Browser](https://www.scrapeless.com/en/scraping-browser) and emits identical JSON shapes — see [`DATA_MODEL.md`](DATA_MODEL.md).
...
| `scrape_user_posts` | — |
| `scrape_post_comments` | `scrapePostComments` |
...
- [`browser/nodejs/results/user.json`](browser/nodejs/results/user.json)
