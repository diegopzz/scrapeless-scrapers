...
[Google Maps](https://www.google.com/maps/) scraper powered by [Scrapeless](https://www.scrapeless.com/). Every surface drives a Scrapeless cloud [Scraping Browser](https://www.scrapeless.com/en/scraping-browser) and emits identical JSON shapes — see [`DATA_MODEL.md`](DATA_MODEL.md).
...
| Python | Node.js |
| --- | --- |
| `scrape_places` | `scrapePlaces` |
| `scrape_place` | `scrapePlace` |
...
- [`browser/nodejs/results/places.json`](browser/nodejs/results/places.json)
- [`browser/nodejs/results/place.json`](browser/nodejs/results/place.json)
